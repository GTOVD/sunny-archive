...
import WaitlistForm from '@/components/treasury/WaitlistForm';
  ...
  return (
    <div className="relative min-h-screen bg-[#020617] text-[#e2e8f0] pt-32 pb-24 px-6">
      ...
      <header className="max-w-7xl mx-auto mb-20 text-center md:text-left">
        <div className="font-['Cinzel'] text-[10px] tracking-[0.6em] text-[#d4af37] uppercase animate-pulse">
        ...
        <div className="h-px w-32 bg-[#d4af37]/30 mt-8 mx-auto md:mx-0" />
        <p className="max-w-md text-[#64748b] text-[10px] uppercase tracking-[0.1em] leading-relaxed mt-8 mx-auto md:mx-0">
      ...
      {products.length > 0 ? (
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-32">
        ...
        <div className="max-w-7xl mx-auto py-20 mb-32 flex flex-col items-center justify-center">
          <TreasuryWaitlist />
        </div>
      )}

      {/* Waitlist Section (Always visible at bottom for additional engagement) */}
      {products.length > 0 && (
        <div className="max-w-md mx-auto py-20 border-t border-white/5">
          <div className="text-center mb-8">
             <h3 className="font-['Playfair_Display'] text-2xl text-white italic mb-2">
               Access Restricted
             </h3>
             <p className="text-[10px] text-[#64748b] uppercase tracking-[0.2em]">
               Join the priority queue for future acquisitions.
             </p>
          </div>
          <WaitlistForm />
        </div>
